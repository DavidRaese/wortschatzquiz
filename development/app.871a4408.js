...
},{"../core-js/object/define-property":"../node_modules/@babel/runtime-corejs2/core-js/object/define-property.js"}],"../scripts/quiz/Quiz.js":[function(require,module,exports) {
"use strict";
...
var Quiz = /*#__PURE__*/function () {
  function Quiz(questions) {
    (0, _classCallCheck2.default)(this, Quiz);
    this.questions = questions;
    this._position = 0;
  }

  (0, _createClass2.default)(Quiz, [{
    key: "getFirstQuestion",
    value: function getFirstQuestion() {
...
},{"@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js"}],"../node_modules/uuid/dist/esm-browser/rng.js":[function(require,module,exports) {
"use strict";
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./v1.js":"../node_modules/uuid/dist/esm-browser/v1.js","./v3.js":"../node_modules/uuid/dist/esm-browser/v3.js","./v4.js":"../node_modules/uuid/dist/esm-browser/v4.js","./v5.js":"../node_modules/uuid/dist/esm-browser/v5.js"}],"../scripts/quiz/Question.js":[function(require,module,exports) {
"use strict";
...
var Question = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Question, [{
    key: "setWasAnswerdCorrectly",
    value: function setWasAnswerdCorrectly(bool) {
...
exports.default = _default;
},{"@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js","@babel/runtime-corejs2/helpers/createClass":"../node_modules/@babel/runtime-corejs2/helpers/createClass.js","uuid":"../node_modules/uuid/dist/esm-browser/index.js"}],"../scripts/quiz/Image.js":[function(require,module,exports) {
"use strict";
...
var Image = function Image(pathToImage) {
  var isCorrectAnswere = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
var _default = Image;
exports.default = _default;
},{"@babel/runtime-corejs2/helpers/classCallCheck":"../node_modules/@babel/runtime-corejs2/helpers/classCallCheck.js"}],"../scripts/utils/dummyData.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.paths = exports.questionStrings = void 0;
var questionStrings = ["Frage 1", "Frage 2", "Frage 3", "Frage 4", "Frage 5", "Frage 6"];
...
var _Quiz = _interopRequireDefault(require("./scripts/quiz/Quiz"));

var _Question = _interopRequireDefault(require("./scripts/quiz/Question"));
...
var questions = _dummyData.questionStrings.map(function (str, count) {
  // 1. generate random number between 0 and 4
  // 2. initialize empty array
  var randNum = Math.floor(4 * Math.random());
  var images = []; // 3. create four new images

  for (var i = 0; i < 4; i++) {
    images.push(new _Image.default(_dummyData.paths[i + count * 4]));
...
var quiz = new _Quiz.default(questions);
...
var prevQuestion = function prevQuestion() {
  var question = quiz.getPreviousQuestion();
  app.textContent = question.questionText;
};

var firstQuestion = function firstQuestion() {
  var question = quiz.getFirstQuestion();
  app.textContent = question.questionText;
};
